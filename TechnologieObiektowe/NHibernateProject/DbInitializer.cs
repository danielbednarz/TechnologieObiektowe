...
namespace NHibernateProject
{
    public class DbInitializer
    {
        ...
        private static List<Medicament> AddMedicaments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Medicaments, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddDepartments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Departments, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddNurses(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Nurses, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddTechnicalWorkers(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.TechnicalWorkers, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static int AddDoctors(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Doctors, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddPatients(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Patients, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddVisits(MainDatabaseContext context, int firstDoctorId)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Visits, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static List<Recipe> AddRecipes(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Recipes, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddRecipeMedicaments(MainDatabaseContext context, List<Recipe> recipes, List<Medicament> medicaments)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.RecipeMedicaments, OperationType.AddRange, addRangeElapsedTime);
