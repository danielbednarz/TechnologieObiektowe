...
namespace NHibernateProject
{
    public class DbInitializer
    {
        ...
        private static List<Medicament> AddMedicaments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Medicaments, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddDepartments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Departments, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddNurses(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Nurses, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddTechnicalWorkers(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.TechnicalWorkers, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static int AddDoctors(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Doctors, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddPatients(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Patients, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static void AddVisits(MainDatabaseContext context, int firstDoctorId)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Visits, OperationType.AddRange, addRangeElapsedTime);
        }
        ...
        private static List<Recipe> AddRecipes(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.Recipes, OperationType.AddRange, addRangeElapsedTime);
        ...
        private static void AddRecipeMedicaments(MainDatabaseContext context, List<Recipe> recipes, List<Medicament> medicaments)
        {
            ...
            Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPH, TableType.RecipeMedicaments, OperationType.AddRange, addRangeElapsedTime);
