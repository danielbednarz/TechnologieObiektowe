...
using (var session = NHibernateExtensions.OpenSession("Server=OMEN-15\\SQLINSTANCE;Database=NHDatabaseTPC;Trusted_Connection=True;Encrypt=False;"))
{
    ...
    try
    {
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Create, seedElapsedTime);
    }
    catch (Exception ex)
    {
    ...
    try
    {
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectReceiptsElapsedTime);
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectDepartmentsVisitsCostsElapsedTime);
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectCompaniesWithMedicamentsCountElapsedTime);
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectPatientWithMostMedicinesElapsedTime);

        var selectDoctorsVisits = StopwatchHelper.MeasureExecutionTime(() => Query.SelectDoctorsVisits(context));
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectDoctorsVisits);
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.MultipleTables, OperationType.Select, selectMedicamentsTypesInFestYearHalf);

        var updateVisitDescriptionsElapsedTime = StopwatchHelper.MeasureExecutionTime(() => Query.UpdateVisitDescriptions(context));
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Visits, OperationType.Update, updateVisitDescriptionsElapsedTime);
        ...
        Logger.WriteCsvLog(OrmType.NHibernate, InheritanceType.TPC, TableType.Visits, OperationType.Update, updateDoctorsSalaryByDepartmentByVisitCount);
