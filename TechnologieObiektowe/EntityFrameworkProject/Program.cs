...
namespace EntityFrameworkProject
{
    public class Program
    {
        public static void Main()
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Create, seedElapsedTime);
        ...
        private static void TestQueries(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Select, select1ElapsedTime);

            Console.WriteLine("\n\nZapytanie 2.");
            var select2ElapsedTime = StopwatchHelper.MeasureExecutionTime(() => Query.Select2(context));
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Select, select2ElapsedTime);

            Console.WriteLine("\n\nZapytanie 3.");
            var select3ElapsedTime = StopwatchHelper.MeasureExecutionTime(() => Query.Select3(context));
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Select, select3ElapsedTime);

            Console.WriteLine("\n\nZapytanie 4.");
            var select4ElapsedTime = StopwatchHelper.MeasureExecutionTime(() => Query.Select4(context));
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Select, select4ElapsedTime);

            Console.WriteLine("\n\nZapytanie 5.");
            var select5ElapsedTime = StopwatchHelper.MeasureExecutionTime(() => Query.Select5(context));
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.MultipleTables, OperationType.Select, select5ElapsedTime);
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPT, TableType.Doctors, OperationType.Update, update2ElapsedTime);
        }
