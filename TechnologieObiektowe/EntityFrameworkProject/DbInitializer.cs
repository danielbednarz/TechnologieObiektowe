...
namespace EntityFrameworkProject
{
    public class DbInitializer
    {
        ...
        private static void AddMedicaments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Medicaments, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddDepartments(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Departments, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddNurses(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Nurses, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddTechnicalWorkers(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.TechnicalWorkers, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static int AddDoctors(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Doctors, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        ...
        private static void AddPatients(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Patients, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddVisits(MainDatabaseContext context, int firstDoctorId)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Visits, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddRecipes(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.Recipes, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
        ...
        private static void AddMedicamentRecipes(MainDatabaseContext context)
        {
            ...
            Logger.WriteCsvLog(OrmType.EntityFramework, InheritanceType.TPC, TableType.RecipeMedicaments, OperationType.AddRange, addRangeElapsedTime + saveChangesElapsedTime);
        }
